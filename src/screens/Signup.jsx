...
export default function Signup() {
  ...
  const onSubmit = (data) => {
    ...
    console.log("Captured Signup Data:", data)

    // Simulate API call and LocalStorage persistence
    setTimeout(() => {
      try {
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-[#f8f5f2]">
        <div className="w-full max-w-md border-none shadow-xl bg-white rounded-lg">
          <div className="p-6 space-y-1">
            ...
            <h2 className="text-2xl font-serif text-center text-amber-900">Create Account</h2>
            <p className="text-center text-gray-500 text-sm">Join our luxury furniture community</p>
          </div>
          ...
          <div className="px-6 pb-6">
            ...
            {success && (
              <div className="mb-4 p-3 rounded-md bg-green-50 border border-green-200 text-green-800">
                ...
                <p className="ml-7 text-sm">Account created. Redirecting to login...</p>
              </div>
            )}
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className={`w-full h-11 px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-amber-500 ${errors.fullName ? 'border-red-500' : 'border-gray-300'}`}
                />
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link to="/" className="text-amber-700 hover:text-amber-900 hover:underline font-medium">
                  Login
                </Link>
              </p>
            </div>
