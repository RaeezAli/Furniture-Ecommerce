    ...
    <main id="page-4" className="mt-20">
      <section className="w-full">
        ...
        <div className="flex flex-col items-center text-center space-y-4">
          <div className="text-3xl font-bold mt-20">Get in touch with us</div>
        ...
        <section className="text-gray-600 body-font relative">
          <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
            <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
              ...
              <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
                <div className="lg:w-1/2 px-6">
                  ...
                  <p className="mt-1">Our address is Gulistan-e-Johar Block 20</p>
                </div>
            ...
            >
              ...
              <button
                type="submit"
                className="text-white bg-[#B88E2F] border-0 py-2 px-6 focus:outline-none rounded text-lg w-[237px]"
              >
                Submit
              </button>
            </form>
